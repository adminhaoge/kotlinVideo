...
object GlobalUtil {
     ...
     * @return 当前应用程序的名称。
     */
    val applicationInfoName: String
    ...
    val appVersionCode: Long
        get() = MyApplication.context.packageManager.getPackageInfo(appPackage,0).versionCode.toLong()
...
//                }catch (e: Exception) {
//                    Log.w(TAG, "getDeviceSerial: ${e.message}")
//                }
//
...
//    }
    ...
    fun isApkInstalled(packageName: String): Boolean {
        val packageInfo: PackageInfo? = try {
            MyApplication.context.packageManager.getPackageInfo(packageName, PackageManager.GET_CONFIGURATIONS)
     ...
     * 判断手机是否安装了QQ。
     */
    fun isQQInstalled() = isApkInstalled("com.tencent.mobileqq")

    /**
     * 判断手机是否安装了微信。
     */
    fun isWechatInstalled() = isApkInstalled("comtencent.mm")

    /**
     * 判断手机是否安装了微博。
     * */
    fun isWeiboInstalled() = isApkInstalled("com.sina.weibo")
    ...
    fun getApplicationMetaData(key: String): String? {
        ...
        try {
            ...
            Log.w(TAG, "getApplicationMetaData: ${e.message}")
        }
