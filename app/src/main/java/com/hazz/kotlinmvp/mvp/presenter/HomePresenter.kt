...
class HomePresenter : BasePresenter<HomeContract.View>(), HomeContract.Presenter {
        ...
        val disposable = homeModel.requestHomeData(num)
                ...
                .subscribe({ homeBean ->
                    ...
                    mRootView?.apply {
                        ...
                        val newBannerItemList = filterBanner(homeBean)
             ...
             homeModel.loadMoreData(it)
                     .subscribe({ homeBean->
                         mRootView?.apply {
                             ...
                             val newItemList = filterBanner(homeBean)
    ...
    private fun filterBanner(homeBean: HomeBean) : ArrayList<HomeBean.Issue.Item>{
