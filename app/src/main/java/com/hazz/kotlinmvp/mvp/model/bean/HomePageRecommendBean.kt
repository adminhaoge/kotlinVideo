 ...
 * @since  2020/5/6
 */
data class HomePageRecommendBean(val itemList: List<Item>, val count: Int, val total: Int, val nextPageUrl: String?, val adExist: Boolean) : Model() {
    ...
    data class Data(
        ...
        val webAdTrack: Any,
        val webUrl: WebUrl,
        val detail: DetailsBean.AutoPlayVideoAdDetail?
    )
